...
training_set = LocalDataset(IMAGES_PATH, TRAINING_PATH, transform=transform_train)
validation_set = LocalDataset(IMAGES_PATH, VALIDATION_PATH, transform=transform_test)
